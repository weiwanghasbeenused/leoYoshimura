...
$next_sibling_item = $page_idx == count($list) - 1 || $uri[1] == 'home' ? null : $list[$page_idx + 1];
$previous_sibling_item = $page_idx == 0 || $uri[1] == 'home' ? null : $list[$page_idx - 1];
if( $next_sibling_item ) $next_sibling_item['url'] = '/' . $next_sibling_item['url'];
if( $previous_sibling_item ) $previous_sibling_item['url'] = '/' . $previous_sibling_item['url'];
$siblings = array(
...
if(sSlideshow_container)
{
	...
	let pageTitle = '<?= addslashes($item['name1']); ?>';
	console.log(siblings);
	slideshow = new Slideshow(sSlideshow_container, images, pageTitle, siblings);
